...
def objective(trial: optuna.trial.Trial):
    ...
    test_months = {'May': ('2014-08-01', '2022-04-30', '2022-05-31'),
                   'June': ('2014-08-01', '2022-05-31', '2022-06-30'),
                   'July': ('2014-08-01', '2022-06-30', '2022-07-31'),
                   'August': ('2014-08-01', '2022-07-31', '2022-08-23')}
    results = {}
...
if __name__ == '__main__':
    ...
    study1.optimize(objective, n_trials=1, timeout=None, catch=(ValueError, ))
